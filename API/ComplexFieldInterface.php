...
{
    /**
     * Returns a non primitive field value - or a primitive field value with custom transformation
     *
     * @param mixed $fieldValue The definition of the field value, as used in the yml file. Can be an array or a scalar value...
