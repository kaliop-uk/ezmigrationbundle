...
* Fixed: when running `kaliop:migration:status --path ...`, the status of skipped or failed migrations might be reported
  incorrectly as not-executed, due to mixing up relative and absolute paths.
  NB: in order for this to work properly, please execute the migration found in file `vendor/kaliop/ezmigrationbundle/MigrationVersions/20220101000200_FixExecutedMigrationsPaths.php`
