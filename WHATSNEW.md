...
* BC change (for developers extending the bundle): all exceptions generated by the bundle now are or extend
  `Kaliop\eZMigrationBundle\API\Exception\MigrationBundleException`
